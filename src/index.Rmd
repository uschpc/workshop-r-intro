...
- Also consider using an integrated development environment (IDE)
  ...
  - Via [CARC OnDemand](https://carc-ondemand.usc.edu)
...
Other packages provide other types:

- [float](https://cran.r-project.org/web/packages/float/index.html) provides single precision float
...
Best to avoid base R and use other packages (performance and features):
